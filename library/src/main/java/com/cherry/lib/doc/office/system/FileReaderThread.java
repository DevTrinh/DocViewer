...
public class FileReaderThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            // doc
            if (fileName.endsWith(MainConstant.FILE_TYPE_DOC) || fileName.endsWith(MainConstant.FILE_TYPE_DOT) || fileType == FileType.DOC) {
                reader = new DOCReader(control, filePath, docSourceType);
            }
            // docx
            else if (fileName.endsWith(MainConstant.FILE_TYPE_DOCX) || fileName.endsWith(MainConstant.FILE_TYPE_DOTX) || fileName.endsWith(MainConstant.FILE_TYPE_DOTM) || fileType == FileType.DOCX) {
            ...
            // xls
            else if (fileName.endsWith(MainConstant.FILE_TYPE_XLS) || fileName.endsWith(MainConstant.FILE_TYPE_XLT) || fileType == FileType.XLS) {
                reader = new XLSReader(control, filePath, docSourceType);
            }
            // xlsx
            else if (fileName.endsWith(MainConstant.FILE_TYPE_XLSX) || fileName.endsWith(MainConstant.FILE_TYPE_XLTX) || fileName.endsWith(MainConstant.FILE_TYPE_XLTM) || fileName.endsWith(MainConstant.FILE_TYPE_XLSM) || fileType == FileType.XLSX) {
                reader = new XLSXReader(control, filePath, docSourceType);
            }
            // ppt
            else if (fileName.endsWith(MainConstant.FILE_TYPE_PPT) || fileName.endsWith(MainConstant.FILE_TYPE_POT) || fileType == FileType.PPT) {
                reader = new PPTReader(control, filePath, docSourceType);
            }
            // pptx
            else if (fileName.endsWith(MainConstant.FILE_TYPE_PPTX) || fileName.endsWith(MainConstant.FILE_TYPE_PPTM) || fileName.endsWith(MainConstant.FILE_TYPE_POTX) || fileName.endsWith(MainConstant.FILE_TYPE_POTM) || fileType == FileType.PPTX) {
